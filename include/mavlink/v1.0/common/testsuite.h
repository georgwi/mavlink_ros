...
static void mavlink_test_puppetcopter_imu(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_puppetcopter_imu_t packet_in = {
		17.0,
	45.0,
	73.0,
	101.0,
	...
	mavlink_puppetcopter_imu_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.pitch = packet_in.pitch;
        	packet1.roll = packet_in.roll;
        	packet1.yaw = packet_in.yaw;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_puppetcopter_imu_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_puppetcopter_imu_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_puppetcopter_imu_pack(system_id, component_id, &msg , packet1.pitch , packet1.roll , packet1.yaw , packet1.xgyro , packet1.ygyro , packet1.zgyro , packet1.xacc , packet1.yacc , packet1.zacc , packet1.slot );
	mavlink_msg_puppetcopter_imu_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_puppetcopter_imu_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pitch , packet1.roll , packet1.yaw , packet1.xgyro , packet1.ygyro , packet1.zgyro , packet1.xacc , packet1.yacc , packet1.zacc , packet1.slot );
	mavlink_msg_puppetcopter_imu_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_puppetcopter_imu_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_puppetcopter_imu_send(MAVLINK_COMM_1 , packet1.pitch , packet1.roll , packet1.yaw , packet1.xgyro , packet1.ygyro , packet1.zgyro , packet1.xacc , packet1.yacc , packet1.zacc , packet1.slot );
	mavlink_msg_puppetcopter_imu_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_puppetcopter_imu(system_id, component_id, last_msg);
}
