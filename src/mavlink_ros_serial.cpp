...
//#include "mavlink_ros/mavlink_msg_roll_pitch_yaw_thrust_setpoint.h"
//#include "mavlink_ros/include/mavlink/v1.0/common/mavlink_msg_roll_pitch_yaw_thrust_setpoint.h"
...
int compid = 110;
int serial_compid = 0;
std::string port = "/dev/ttyACM0";              ///< The serial port name, e.g. /dev /ttyACM0
...
/******************************************************************************************************************************************/
	...
	// SETUP ROS
	ros::NodeHandle n;
	mavlink_sub = n.subscribe("/to_MAVLink_node", 1000,  OurFunction);// filippo /topic che arriva= controller/out to_MAVLink_node
